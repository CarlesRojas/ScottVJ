...
void Ramona::init(const glm::vec2 & initialPos, UI * ui, const int windowHeight, ShaderProgram * shaderProgram)
{
	...
	sprite->addKeyframe(PUNCH3, glm::vec2(12 * 0.05f, 3 * 0.05f));
	sprite->addKeyframe(PUNCH3, glm::vec2(13 * 0.05f, 3 * 0.05f));
	...
	sprite->addKeyframe(SPECIAL, glm::vec2(10 * 0.05f, 0 * 0.05f));
	sprite->addKeyframe(SPECIAL, glm::vec2(11 * 0.05f, 0 * 0.05f));
	sprite->addKeyframe(SPECIAL, glm::vec2(12 * 0.05f, 0 * 0.05f));
	...
	sprite->addKeyframe(SPIN, glm::vec2(17 * 0.05f, 6 * 0.05f));
	sprite->addKeyframe(SPIN, glm::vec2(18 * 0.05f, 6 * 0.05f));
	sprite->addKeyframe(SPIN, glm::vec2(19 * 0.05f, 6 * 0.05f));
