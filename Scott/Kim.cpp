...
void Kim::init(const glm::vec2 & initialPos, UI * ui, const int windowHeight, ShaderProgram * shaderProgram)
{
	...
	sprite = Sprite::createSprite(true, glm::vec2(256.f * scaleFactor, 256.f * scaleFactor), glm::vec2(0.05, 0.1f), &Load::instance().kim, shaderProgram);
	...
	Sprite * monster = Sprite::createSprite(true, glm::vec2(256.f * scaleFactor, 256.f * scaleFactor), glm::vec2(0.05, 0.1f), &Load::instance().kim, shaderProgram);
	monster->setNumberAnimations(1);

	monster->setAnimationSpeed(0, 8);
	monster->addKeyframe(0, glm::vec2(0 * 0.05f, 8 * 0.1f));
	monster->addKeyframe(0, glm::vec2(1 * 0.05f, 8 * 0.1f));
	monster->addKeyframe(0, glm::vec2(2 * 0.05f, 8 * 0.1f));
	monster->addKeyframe(0, glm::vec2(3 * 0.05f, 8 * 0.1f));
	monster->addKeyframe(0, glm::vec2(4 * 0.05f, 8 * 0.1f));
	monster->addKeyframe(0, glm::vec2(5 * 0.05f, 8 * 0.1f));
	monster->addKeyframe(0, glm::vec2(6 * 0.05f, 8 * 0.1f));
	monster->addKeyframe(0, glm::vec2(7 * 0.05f, 8 * 0.1f));
	monster->addKeyframe(0, glm::vec2(8 * 0.05f, 8 * 0.1f));
...
float Kim::getSpecialAttackDuration()
{
	return 9.5f / 8.f;
}
